    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            void GeneratePlate(string plateId)
            {
                ...
                string filePath = "C:\\Users\\bhh\\OneDrive - mercantec\\Programmering valgfag\\banko-Boris-Henriksen\\BankoCheater\\Selenium\\data.json";
